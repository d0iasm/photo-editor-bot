            ...
            foreach ($events as $event) {
                ...
                if($event instanceof ImageMessage){
                    ...
                    if ($binaryImage->isSucceeded()) {
                      ...
                      $editedImage = new ImageMessageBuilder('https://s3-ap-northeast-1.amazonaws.com/photo-editor-bot/pome.jpg', 'https://s3-ap-northeast-1.amazonaws.com/photo-editor-bot/150x150.jpg');
